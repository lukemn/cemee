...
rdm_spl=NULL
for(i in 1:400) rdm_spl = rbind(rdm_spl, sample(1500,10))
...
vect_margin=rbind(c(1.5,4,1.5,0),c(1.5,2,1.5,2),
                  c(1.5,0,1.5,4),c(2,4,1,0),
                  c(2,2,1,2),c(2,0,1,4))
...
for(k in 1:6){
  ...
  plot(post_modes_temp[c(1:7,10)]~vect_y_pops,
       ylim=c(0.002,0.3),type="n",log="y",xlim=c(-35,120),
       xlab="Generation",ylab="",bty="n",xaxt="n",yaxt="n",main= vect_main[k],cex.main=2)
