...
export_Genomic <- data_for_G_estimation[,c(2,3,5,24:29)]
write.table(export_Genomic,file="~/PATH/TO/DIR/Cemee_Pop_WI/Phen_table_for_genomic_G_estimation.txt",sep="\t",quote=FALSE,row.names=FALSE)
...
write.table(VCV_mat[[k]]$G1_mat, quote=FALSE,sep="\t", row.names=FALSE,col.names=FALSE, file=paste0("~/PATH/TO/DIR/Cemee_Pop_WI/G_mat_for_simulations/", vect_pop_id,".txt"))
