...
model_MCMC_Rdm <- MCMCglmm(Y_temp ~1+(T12+T13+T21+T23+T31+T32)^2-(T12+T13+T21+T23+T31+T32)+ I(T12^2)+ I(T13^2)+I(T21^2)+ I(T23^2)+I(T31^2)+ I(T32^2), data = final_fertility ,verbose = FALSE,nitt=150000, burnin=100000,thin=10)

if(length(model_MCMC_Rdm)==20){
post_mod_gamma_Rdm =cbind(post_mod_gamma_Rdm ,posterior.mode(model_MCMC_Rdm$Sol)[2:22])
...
model_MCMC <- MCMCglmm(Y ~1+(T12+T13+T21+T23+T31+T32)^2-(T12+T13+T21+T23+T31+T32)+ I(T12^2)+ I(T13^2)+I(T21^2)+ I(T23^2)+I(T31^2)+ I(T32^2), data = final_fertility ,verbose = TRUE,nitt=50500000, burnin=500000,thin=100)
