...
MAKE_WCON=false
NP=8
CONV=wcon/multiwormtracker/blobs2wcon.R
...
# Thiago's scripts
# tar
ARCHIVE=wcon/celegans_behavior-master/Utils/archive_exper_behavior_data.sh 
...
PROCESS=wcon/celegans_behavior-master/Utils/process_archived_exper_behavior_data.sh
