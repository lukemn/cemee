...
## there are two dupes in cryo (one, CA150L29, in v1/2). leave in sheet, but drop for table
#meta[which(meta$line %in% names(table(meta$line)[table(meta$line)>1])), c('line', 'v1', 'v2', 'v2 QC')]
#meta$line[which(meta$line %in% names(table(meta$line)[table(meta$line)>1]))]
# v2 = subset(meta[-which(meta$line == 'CA150L29')[1],], v2==1 & `v2 QC` == 'PASS'); dim(v2)
