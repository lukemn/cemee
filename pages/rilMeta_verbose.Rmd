...
sketch = htmltools::withTags(table(
  ...
  thead(
    tr(
      ...
      th('Fert. NGM', title = 'Phenotyped for fertility (number of viable L1s) on NGM. Value is the number of observations (adult worms) post-QC.'),
      th('Fert. NaCl', title = 'Phenotyped for fertility (number of viable L1s) on NGM + 305mM NaCl. Value is the number of observations (adult worms) post-QC.'),
