...
* [R/qtl files](https://github.com/lukemn/cemee/tree/gh-pages/cemee_v2_resource/rqtl) Pre-built csv input for [R/qtl](https://rqtl.org/). Available in WS220 and WS245 coordinates, and pre-pruned by LD.
* [R/qtl2 files](https://github.com/lukemn/cemee/tree/gh-pages/cemee_v2_resource/rqtl) Pre-built zip archive input for [R/qtl2](https://kbroman.org/qtl2/). Available in WS220 and WS245 coordinates, and pre-pruned by LD.
