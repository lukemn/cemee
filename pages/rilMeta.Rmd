...
Basic information for existing RILs (and a few populations). Not all have been sequenced yet, and fewer have been phenotyped. Hover over the columns for more information.

There's also [a more verbose version](pages/rilMeta_verbose.html) with additional sequencing and QC metadata.xxx
